...
class PartidaMus:
    def __init__(self, id_jugador_1, id_jugador_2):
        ...
        self.estado = {
            self.j1: {'cartas': [], 'puntos': 0, 'quiere_mus': None, 'descartes_listos': False},
            self.j2: {'cartas': [], 'puntos': 0, 'quiere_mus': None, 'descartes_listos': False}
        }
        
        self.fase = 'espera' # espera, mus, descarte, apuestas, recuento
        
        # Máquina de estados de las apuestas
    ...
    def __init__(self, id_jugador_1, id_jugador_2):
        ...
        # El J1 empieza siendo mano por defecto
        self.id_mano = self.j1 
        self.id_postre = self.j2
        
        self.baraja = []
        self.descartes = []
        
        # Añadimos 'descartes_hechos'
        self.estado = {
        ...
        self.fase = 'espera' # espera, descarte, apuestas, recuento
        # Máquina de estados de las apuestas
        self.fases_apuesta = ['Grande', 'Chica', 'Pares', 'Juego']
        self.indice_fase = 0
        self.botes = {'Grande': 0, 'Chica': 0, 'Pares': 0, 'Juego': 0}
